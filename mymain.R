...
mypredict <- function() {
  ...
  for (dept in test_depts) {
    ...
    test_month2 <- update_forecast(test_month, f_snaive, dept, 2)
    test_month3 <- update_forecast(test_month, f_tslm, dept, 3)
    test_month$Weekly_Pred2 <- test_month2$Weekly_Pred2
    test_month$Weekly_Pred3 <- test_month3$Weekly_Pred3
  }
